...
plt.plot(distances, results3, marker='x', markersize=4, label="3 angles")
plt.plot(distances, results4, marker='o', markersize=4, label="4 angles")
plt.plot(distances, results5, marker='^', markersize=4, label="5 angles")
plt.plot(distances, results6, marker='P', markersize=4, label="6 angles")
